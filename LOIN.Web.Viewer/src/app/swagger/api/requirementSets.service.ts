...
import { RequirementSet } from '../model/requirementSet';
...
export class RequirementSetsService {
    ...
    public apiRepositoryIdRequirementSetsGet(repositoryId: string, select?: string, filter?: string, orderby?: string, skip?: number, top?: number, apply?: string, actors?: string, reasons?: string, breakdown?: string, milestones?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<RequirementSet>>('get',`${this.basePath}/api/${encodeURIComponent(String(repositoryId))}/requirement-sets`,
            {
    ...
    public apiRepositoryIdRequirementSetsIdGet(id: number, repositoryId: string, select?: string, filter?: string, orderby?: string, skip?: number, top?: number, apply?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (repositoryId === null || repositoryId === undefined) {
            throw new Error('Required parameter repositoryId was null or undefined when calling apiRepositoryIdRequirementSetsIdGet.');
        }
        ...
        return this.httpClient.request<RequirementSet>('get',`${this.basePath}/api/${encodeURIComponent(String(repositoryId))}/requirement-sets/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiRepositoryIdRequirementSetsIdRequirementsGet(id: number, repositoryId: string, select?: string, filter?: string, orderby?: string, skip?: number, top?: number, apply?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Requirement>>;
    public apiRepositoryIdRequirementSetsIdRequirementsGet(id: number, repositoryId: string, select?: string, filter?: string, orderby?: string, skip?: number, top?: number, apply?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Requirement>>>;
    public apiRepositoryIdRequirementSetsIdRequirementsGet(id: number, repositoryId: string, select?: string, filter?: string, orderby?: string, skip?: number, top?: number, apply?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Requirement>>>;
    public apiRepositoryIdRequirementSetsIdRequirementsGet(id: number, repositoryId: string, select?: string, filter?: string, orderby?: string, skip?: number, top?: number, apply?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiRepositoryIdRequirementSetsIdRequirementsGet.');
        }

        if (repositoryId === null || repositoryId === undefined) {
            throw new Error('Required parameter repositoryId was null or undefined when calling apiRepositoryIdRequirementSetsIdRequirementsGet.');
        }
        ...
        return this.httpClient.request<Array<Requirement>>('get',`${this.basePath}/api/${encodeURIComponent(String(repositoryId))}/requirement-sets/${encodeURIComponent(String(id))}/requirements`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
